...
> 我们设定表的大小总是偏向于设为素数：
> 
> 其一，尽管 Key 可能具有一些奇奇怪怪的性质，hash(Key) 依然表现良好，容错率高
> 
...
- 其一，别人证过的东西我没必要再在上面花时间了，人生苦短
- 其二，不会，目前我的水平还无法质疑这个结果，管他那么多干什么，信它就对了
...
在这个方法下，标准的删除是有问题的，我们采用**懒惰删除**

( 根据这个方法的定义，容易得出这个结论 )

**懒惰删除**：当一个元素要被删除时，它仍然留在表中，只是做一个删除的记号
